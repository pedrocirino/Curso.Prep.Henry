...
function todosIguales(arreglo) {
  //Escriba la función todosIguales, que indique 
  //si todos los elementos de un arreglo son iguales:
...
function mayorACien(array) {
  //La función recibe un array con enteros entre 0 y 200. Recorrer el array y guardar en un nuevo 
  //array sólo los
